...
$surat = mysqli_query($conn, "SELECT * FROM izin ORDER BY id_surat DESC LIMIT 1");
$srt = mysqli_fetch_array($surat);
$id_surat = $srt["id_surat"] + 1;
    ...
    if (tambah($_POST) > 0) {
        echo "
            <Script>
                ...
                window.setTimeout(function(){ window.open('cetak.php?id_surat=$id_surat', '_blank');window.location.replace('riwayat.php?hal=1') } ,3000);
            </Script>
        ";
    }else{
        echo "
            <script>
                ...
                window.setTimeout(function(){ window.location.replace('riwayat.php?hal=1'); } ,2000);
            </script>
        ";
    }
}
        ...
        <div class="row">
            ...
            <div class="col-md-6 form">
                ...
                <form action="" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary" name="tambah">Simpan & Cetak</button>
                </form>
            </div>
        </div>
   </div> 
